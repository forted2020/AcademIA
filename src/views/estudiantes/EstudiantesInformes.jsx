            ...
            <CContainer>
                ...
                <CCard className="mb-1" >       {/* Contenedor que actúa como cuerpo de la tarjeta CCard. Envuelve todo el contenido*/}
                    ...
                    <CCardBody className="px-4 pt-1 pb-2 border border-light">
                        ...
                        {/* ----------  BODY --------------- */}
                        <CCardBody className="px-1 pt-1 pb-1 border border-light">
                            ...
                            <CCard className="mb-4 no-print shadow-sm">
                                ...
                                <CCardBody>
                                    <CRow className="g-4 align-items-end">
                                        ...
                                        <CCol sm={6} lg={3}>
                                            <StatCard
                                                title="Promedio General Promedio General"
                                                //value={academicData.summary.average}
                                                //icon={cilChartLine}
                                                color="primary"
                                                subtext="Escala de 1 a 10 Escala de 1 a 10 Escala de 1 a 10 Escala de 1 a 10 Escala de 1 a 10 Escala de 1 a 10 Escala de 1 a 10 Escala de 1 a 10 "
                                            />
                                        </CCol>
                                        <CCol sm={6} lg={3}>
                                            <StatCard
                                            title="Materias Aprobadas Materias Aprobadas" 
                                            // value={academicData.summary.approved}
                                            //icon={cilCheckCircle} 
                                             color="success"
                                            />
                                        </CCol>
